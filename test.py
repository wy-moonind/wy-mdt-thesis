...
# data = np.vstack((time, inner07[0:3000, :].T, inner14[0:3000, :].T, inner21[0:3000, :].T, inner28[0:3000, :].T))
# print(data.shape)
# np.save("../fig_data/5.2", data)
...
# data = np.vstack((time, ball07[0:3000, :].T, ball14[0:3000, :].T, ball21[0:3000, :].T))
# print(data.shape)
# np.save("../fig_data/5.8", data)
# plt.show()
...
data = np.vstack((time, outer07[0:3000, :].T, outer14[0:3000, :].T))
print(data.shape)
np.save("../fig_data/5.13", data)
plt.show()
