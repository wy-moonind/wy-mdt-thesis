...
# plt.show()
data_ball07 = scio.loadmat("C:/Users/wangy/Desktop/Thesis_new/bearing_data/case/preprocessed/ball_fd07_preprocessed.mat")
ball07 = data_ball07.get("ball_fd07_4")
data_ball14 = scio.loadmat("C:/Users/wangy/Desktop/Thesis_new/bearing_data/case/preprocessed/ball_fd14_preprocessed.mat")
ball14 = data_ball14.get("ball_fd14_4")
data_ball21 = scio.loadmat("C:/Users/wangy/Desktop/Thesis_new/bearing_data/case/preprocessed/ball_fd21_preprocessed.mat")
ball21 = data_ball21.get("ball_fd21_4")
# data_inner28 = scio.loadmat("C:/Users/wangy/Desktop/Thesis_new/bearing_data/case/preprocessed/inner_fd28_preprocessed.mat")
...
plt.xlabel("Time[s]")
plt.legend(["Ball, fd=0.007"], loc="upper right")
plt.subplot(3, 1, 2)
plt.plot(time, ball14[0:3000, :])
plt.xlabel("Time[s]")
plt.legend(["Ball race, fd=0.014"], loc="upper right")
plt.subplot(3, 1, 3)
plt.plot(time, ball21[0:3000, :])
plt.xlabel("Time[s]")
plt.legend(["Ball race, fd=0.021"], loc="upper right")
# plt.subplot(4, 1, 4)
# plt.plot(time, inner28[0:3000, :])
# plt.xlabel("Time[s]")
# plt.legend(["Inner race, fd=0.028"], loc="upper right")
plt.savefig('../figs/cwru_ball_example', dpi=300, bbox_inches='tight')
plt.show()
