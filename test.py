...
# plt.show()
data_inner07 = scio.loadmat("C:/Users/wangy/Desktop/Thesis_new/bearing_data/case/preprocessed/inner_fd07_preprocessed.mat")
inner07 = data_inner07.get("inner_fd07_4")
data_inner14 = scio.loadmat("C:/Users/wangy/Desktop/Thesis_new/bearing_data/case/preprocessed/inner_fd14_preprocessed.mat")
inner14 = data_inner14.get("inner_fd14_4")
data_inner21 = scio.loadmat("C:/Users/wangy/Desktop/Thesis_new/bearing_data/case/preprocessed/inner_fd21_preprocessed.mat")
...
plt.xlabel("Time[s]")
plt.legend(["Inner race, fd=0.007"], loc="upper right")
plt.subplot(4, 1, 2)
plt.plot(time, inner14[0:3000, :])
plt.xlabel("Time[s]")
plt.legend(["Inner race, fd=0.014"], loc="upper right")
plt.subplot(4, 1, 3)
plt.plot(time, inner21[0:3000, :])
plt.xlabel("Time[s]")
plt.legend(["Inner race, fd=0.021"], loc="upper right")
plt.subplot(4, 1, 4)
